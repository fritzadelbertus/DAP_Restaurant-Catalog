class RestaurantMiniCard extends HTMLElement {
  ...
  async render() {
    ...
    <div class="poster">
      <img 
        src="${baseUrl}small/${pictureId}" 
        class="lazyload"
        alt="${name}">
    </div>
    <div class="info">
      <h3 class="restaurant-mini-card__title">
        <a href="/#/detail/${id}"
          aria-label="
            ${name},
            lokasi: ${city},
...
customElements.define('restaurant-mini-card', RestaurantMiniCard);
